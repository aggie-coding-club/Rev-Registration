...
const InfoPage: React.FC<RouteComponentProps> = () => (
  <div className={styles.pageContent}>
    <CaptionedGif titleText="Adding a Course" gifAddress={`${STATIC_URL}/HowToUseBoilerPlate.gif`}>
      <Typography>
    ...
    <CaptionedGif titleText="Selecting Sections to Include In Schedule Generation" gifAddress={`${STATIC_URL}/HowToUseBoilerPlate.gif`}>
      <Typography>
          ...
          for when you aresearching for sections of a specific attribute such as honors or online.
    ...
    <CaptionedGif titleText="Blocking off busy times" gifAddress={`${STATIC_URL}/HowToUseBoilerPlate.gif`}>
      <Typography>
    ...
    <CaptionedGif titleText="Generating Schedules" gifAddress={`${STATIC_URL}/HowToUseBoilerPlate.gif`}>
      <Typography>
    ...
    <CaptionedGif titleText="Saving/Naming Schedules" gifAddress={`${STATIC_URL}/HowToUseBoilerPlate.gif`}>
      <Typography>
    ...
    <CaptionedGif titleText="Schedule Details" gifAddress={`${STATIC_URL}/HowToUseBoilerPlate.gif`}>
      <Typography>
