...
def parse_section(course,i):
    #gets values to create object
    section_id = int(course['id'])
    section_subject = course['subject']
    course_number = course['courseNumber']
    section_number = int(course['sequenceNumber'])
...
def parse_meeting(i):
    ...
    meeting_section = ''#this should be an object
...
def parse_course(course):
    ...
    c = Course(id=course_id, dept=course_dept, course_num=course_number, title=course_title, description=course_desc, prerequisites=course_prereqs, corequisites=course_coreqs, cd=course_cd, icd=course_icd, core_curriculum=course_core_curriculum, credit_hours=course_credit_hours, term=course_term_code)
    c.save()
